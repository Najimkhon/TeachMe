...
import com.example.teachme.ui.layouts.SelectedStudentItemLayout
import com.example.teachme.ui.layouts.StudentDialogItemLayout
import com.example.teachme.ui.layouts.StudentItemLayout

class SelectedStudentAdapter(
    val context: Context
) : RecyclerView.Adapter<SelectedStudentAdapter.StudentDialogViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StudentDialogViewHolder {
        return StudentDialogViewHolder(SelectedStudentItemLayout(context))
    }
    ...
    inner class StudentDialogViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val layout = itemView as SelectedStudentItemLayout
    }
}
